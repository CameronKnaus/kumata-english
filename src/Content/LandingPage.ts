...
const LANDING_TEXT = {
  ...
  myYoutube: 'Youtube',
  imageAria:
    '英語が人生を楽しくしてくれる。あなたも英語で人生をより豊かにしませんか？',
  servicesHeader: {
  ...
  onlineLessons: {
    ...
    manToMan: '【マンツーマン】',
    answerAllQuestions:
      'マンツーマンレッスンなので、不明点は何でも質問して頂けます！',
    serviceDescription:
      '僕自身、英語を学生から今まで勉強してきて、「こんなレッスンがあったら、もっと早く覚えることができるのに」と思うことが何度もありました。その内容を詰め込み、語彙力や、様々なフレーズを使えるようになる為のレッスンです！レッスン内で何度も復習・練習するので、繰り返していくごとに自分の意見を言えるようになっていきます！',
  ...
  coaching: {
    ...
    serviceDescription:
      '英語コーチングとは、生徒さんに専門のコーチがつき、短期間（2〜3ヶ月）で英語を集中的に学べる教育法のことです！',
    ...
    selfDoubtSection: {
      ...
      solution:
        'クマタコーチングでは、毎日勉強法に就いてのアドバイス、モチベーションを維持できるようにメンタル面でのサポートを提供します！',
    },
    noEnglishSection: {
      title: '【英語力がゼロからでも大丈夫！】',
      description:
        '週に数回受講する形式の「英会話」とは異なり、あなたの毎日を「マンツーマン」でサポート。',
      solution:
        '英語力がゼロの状態からでも、短期間で成長を感じることができます。',
    },
    importantTopics: {
      header: '【英語の学習で大切なこと】',
      pointsList: [
    ...
    closingDescLine:
      '今、「英語を始めて見たい」と思っているのであれば、その時がベストタイミングです！',
    costMenu: {
  ...
  youtube: {
    ...
    topics: '提供しているトピックス',
    videoTypeList: ['発音の方法', 'TOEICの解説', '勉強法', 'モチベーション'],
    closingRemark:
      '様々な動画を投稿しているので、英語の学習の際にぜひご覧ください！',
  ...
  instagram: {
    ...
    header: '毎日投稿しております！',
    instaDescription:
      '日常で使える英会話フレーズを毎日投稿しています！また、英語の勉強法やモチベーションを保つ方法なども投稿しているので、ぜひチェックしてみてね！',
  ...
  beebogo: {
    ...
    description:
      '英語コーチングやレッスンで習った単語を忘れないようにBeeboGoで復習できます！自分専用の単語クイズを自動で作成してくれるアプリです。',
    toBeeboGo: 'BeeboGoへ',
  },
};
