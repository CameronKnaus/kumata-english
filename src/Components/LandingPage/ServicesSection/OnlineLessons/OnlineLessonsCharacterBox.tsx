        ...
        <div ref={ref} id="doubts-container">
          {doubtsList.map((_, index) => {
            return (
              <animated.div
                key={`doubt-${index}`}
                className={`${styles.thoughtText} ${thoughtTextClass}`}
                style={springsList[index]}
              >
                {doubtsList[index]}
              </animated.div>
            );
        ...
        <div className={styles.imageContainer}>
          {transitions(({ opacity }, item) =>
            item ? (
              ...
              >
                <Image
                  regularImage={regularHappyKumata}
                  webpImage={webpHappyKumata}
                  imageBaseType="png"
                  classes={styles.characterImage}
                />
              </animated.div>
            ) : (
              <animated.div
